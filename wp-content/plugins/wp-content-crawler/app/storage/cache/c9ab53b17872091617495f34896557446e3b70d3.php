        ...
        <tbody>
            ...
            <tr class="events-last">
                ...
                <?php $__currentLoopData = $lastEventDates; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    ?>
                    <td class="<?php echo e($eventClass); ?>">
                        <div class="diff-for-humans"><?php echo sprintf(_wpcc("%s ago"), \WPCCrawler\Utils::getDiffForHumans(strtotime($eventDate))); ?></div> <span class="date">(<?php echo e(\WPCCrawler\Utils::getDateFormatted($eventDate)); ?>)</span>
                    </td>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </tr>
        </tbody>
...
], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\dieuhau\wp-content\plugins\wp-content-crawler\app\views/dashboard/section-whats-happening.blade.php ENDPATH**/ ?>