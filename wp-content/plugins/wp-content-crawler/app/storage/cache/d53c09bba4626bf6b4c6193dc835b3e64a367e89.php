<div class="input-group remove-element-attributes <?php echo e(isset($addon) ? 'addon dev-tools' : ''); ?> <?php echo e(isset($remove) ? 'remove' : ''); ?>"
    ...
    <?php endif; ?>
</div><?php /**PATH /home/thegioio/domains/thegioioplung.xyz/public_html/wp-content/plugins/wp-content-crawler/app/views/form-items/remove-element-attributes.blade.php ENDPATH**/ ?>