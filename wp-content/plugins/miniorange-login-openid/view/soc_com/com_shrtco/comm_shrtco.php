...
function select_comment_shortcode(){
    ...
    <div class="mo_openid_table_layout" id="openid_comments_shortcode" style="font-size:13px !important">
        ...
        <i style= "width: 11px;height: 9px;padding-left:2px;padding-top:3px" class="fa fa-fw fa-lg fa-copy mo_copy mo_copytooltip" onclick="copyToClipboard(this, '#10', '#shortcode_url10_copy')"><span id="shortcode_url10_copy" class="mo_copytooltiptext">Copy to Clipboard</span></i>
        <br/><br/>
